...
const SOCIAL_PLATFORMS = [
    ...
    { icon: Icons.linkedin, position: "left-1", size: "large", iconSize: "large" },
    { icon: Icons.reddit, position: "right-1", size: "large", iconSize: "large" },
    { icon: Icons.youtube, position: "right-2", size: "medium", iconSize: "medium" },
];
